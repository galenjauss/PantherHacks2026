...
<div class="dark min-h-svh bg-snip-bg text-snip-text-primary">
	<div class="mx-auto flex min-h-svh w-full max-w-7xl flex-col px-4 py-4 sm:px-5 lg:px-8">
		<header class="sticky top-4 z-20 flex items-center justify-between gap-6 rounded-full border border-snip-border bg-snip-surface/95 px-4 py-3 backdrop-blur">
			<div class="flex items-center gap-3">
				<div class="flex size-10 items-center justify-center rounded-2xl bg-primary text-primary-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_10px_24px_rgba(124,58,237,0.25)]">
		...
		<section class="relative flex min-h-[calc(100svh-7rem)] items-center justify-center overflow-hidden py-16 sm:py-20">
			<div class="pointer-events-none absolute inset-0 overflow-hidden">
				<div class="absolute left-[8%] top-[22%] h-[28rem] w-[22rem] rotate-[-12deg] rounded-[2.5rem] border border-white/6 bg-[linear-gradient(145deg,rgba(248,248,246,0.96),rgba(224,223,218,0.9))] shadow-[0_28px_80px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.95)]"></div>
				<div class="absolute left-[10%] top-[25%] h-[28rem] w-[22rem] rotate-[-12deg] rounded-[2.5rem] bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.75),transparent_34%),linear-gradient(145deg,rgba(241,240,235,0.8),rgba(210,208,202,0.72))] opacity-70"></div>
				<div class="absolute left-[19%] top-[34%] h-40 w-40 rounded-full bg-white/10 blur-3xl"></div>
				<div class="absolute left-[24%] top-[22%] h-[21rem] w-px rotate-[26deg] border-l-2 border-dashed border-primary/55 opacity-80"></div>

				<div class="absolute left-[20%] top-[29%] rotate-[16deg]">
					<div class="relative">
						<div class="absolute inset-0 rounded-full bg-primary/25 blur-2xl"></div>
						<div class="relative flex size-24 items-center justify-center rounded-full bg-[linear-gradient(145deg,#bb6cff,#7c3aed)] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.28),0_20px_36px_rgba(124,58,237,0.28)]">
							<ScissorsIcon class="size-12" stroke-width={2.4} />
						</div>
					</div>
				</div>

				<div class="absolute right-[9%] bottom-[16%] h-[24rem] w-[18rem] rotate-[8deg] rounded-[2.75rem] border border-white/5 bg-[linear-gradient(145deg,rgba(248,248,246,0.12),rgba(255,255,255,0.02))] shadow-[0_20px_80px_rgba(0,0,0,0.32)] opacity-50"></div>
			</div>

			<div class="relative z-10 flex w-full max-w-4xl flex-col items-center text-center">
		...
		<section class="pb-16 pt-4 sm:pb-20">
			<div class="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
				<div class="space-y-4">
					<p class="text-xs font-medium uppercase tracking-[0.28em] text-muted-foreground">
						Sample snip
					</p>
					...
					<p class="max-w-xl text-base leading-7 text-snip-text-secondary">
						This section is here to test the scroll experience and give you a place to show a
						sample clip being trimmed. Right now it uses your scissor-cutting reference animation.
					</p>
				</div>

				<div class="rounded-[2rem] border border-snip-border bg-snip-surface p-4 shadow-[0_24px_70px_rgba(0,0,0,0.34)]">
					<div class="overflow-hidden rounded-[1.5rem] border border-snip-border bg-black">
						<video
					...
					<div class="mt-4 flex items-center justify-between gap-4">
						<div>
							<p class="text-sm font-medium text-white">Scissor cutting reference</p>
							<p class="mt-1 text-sm text-snip-text-secondary">
								Used as a stand-in for the future sample snip preview.
							</p>
						</div>
						<div class="rounded-full border border-snip-border bg-snip-surface-elevated px-3 py-1 text-xs text-snip-text-secondary">
							webm sample
						</div>
					</div>
				</div>
